    ...
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="mx-auto max-w-5xl px-6">
        <div className="mt-4 flex items-center justify-between rounded-full glass px-5 py-3">
          ...
          <a href={site.radio.url} target="_blank" rel="noopener noreferrer" className="text-sm font-medium bg-ink text-bg rounded-full px-4 py-1.5 hover:opacity-85 transition-opacity">Live luisteren</a>
        </div>
      </div>
    </header>
  );
