...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative overflow-hidden pt-52 pb-24 sm:pt-60 sm:pb-32"
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6">
        <div className="grid sm:grid-cols-[1.1fr,0.9fr] gap-14 items-center">
          <div className="animate-fade-up">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <a
                ...
                className="rounded-full bg-onair text-white text-sm font-semibold px-6 py-3 hover:brightness-110 transition-all"
              >
                {site.radio.cta}
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-full glass text-ink text-sm font-semibold px-6 py-3 hover:bg-white/[0.06] transition-colors"
              >
                {site.label.cta}
              </a>
            </div>
          ...
          <div className="relative animate-fade-up [animation-delay:150ms]">
            <div
              className="absolute -inset-6 rounded-[2.5rem] bg-gradient-to-tr from-onair/25 via-gold/10 to-transparent blur-2xl"
              aria-hidden="true"
            />
